...
describe('FileTrie', () => {
	...
	describe('fromEntries', () => {
		test('nested', () => {
			const trie = FileTrieNode.fromEntries([
				...
				['folder/file1' as FullSlug, { title: 'File 1', slug: 'folder/file1', filePath: 'folder/file1.md' }],
				[
					'folder/index' as FullSlug,
					{ title: 'Folder Index', slug: 'folder/index', filePath: 'folder/index.md' },
				],
				['folder/file2' as FullSlug, { title: 'File 2', slug: 'folder/file2', filePath: 'folder/file2.md' }],
				[
	...
	describe('findNode', () => {
		...
		test('should find nested node', () => {
			...
			assert.strictEqual(trie.findNode(['folder', 'subfolder', 'index']), trie.children[0].children[0])
	...
	describe('getFolderPaths', () => {
		test('should return all folder paths', () => {
			...
			assert.deepStrictEqual(paths, ['index', 'folder/index', 'folder/subfolder/index', 'abc/index'])
		})
	})
